...
public class TestSynonymGraphFilter extends BaseTokenStreamTestCase {
  ...
  public void testSimple() throws Exception {
    ...
    assertAnalyzesTo(
        analyzer, "i-pod", new String[] {"ipod", "ipoooood", "i-pod"}, new int[] {1, 0, 0});
  ...
  public void testBasicKeepOrigTwoOutputs() throws Exception {
    ...
    assertAnalyzesTo(
        ...
        new String[] {
          "word", "SYNONYM", "SYNONYM", "word", "SYNONYM", "SYNONYM", "SYNONYM", "word", "word"
        },
  ...
  static class CustomAnalyzer extends Analyzer {
    ...
    protected TokenStreamComponents createComponents(String s) {
      ...
      TokenStream tokenStream =
          new SynonymGraphFilter(tokenizer, synonymMap, true); // Ignore case True
