...
public class TestUnifiedHighlighterStrictPhrases extends LuceneTestCase {
  ...
  public void testBasics() throws IOException {
    indexWriter.addDocument(
        newDoc("Yin yang, filter")); // filter out. test getTermToSpanLists reader 1-doc filter
  ...
  public void testSubPhrases() throws IOException {
    ...
    if (highlighter.getFlags("body").contains(HighlightFlag.WEIGHT_MATCHES)) {
      assertArrayEquals(
          new String[] {"<b>alpha bravo charlie</b> - charlie bravo alpha"}, snippets);
    } else {
      assertArrayEquals(
          new String[] {"<b>alpha</b> <b>bravo</b> <b>charlie</b> - charlie bravo alpha"},
          snippets);
    }
  }
  ...
  public void testRewrite() throws IOException {
    ...
    if (highlighter.getFlags("body").contains(HighlightFlag.WEIGHT_MATCHES)) {
      assertArrayEquals(
          new String[] {"<b>alpha bravo</b> <b>charlie</b> - charlie bravo alpha"}, snippets);
    } else {
      assertArrayEquals(
          new String[] {"<b>alpha</b> <b>bravo</b> <b>charlie</b> - charlie bravo alpha"},
          snippets);
  ...
  public void testMtq() throws IOException {
    ...
    assertArrayEquals(
        new String[] {"<b>alpha</b> <b>bravo</b> <b>charlie</b> - charlie bravo alpha"}, snippets);
  }
  ...
  public void testMultiValued() throws IOException {
    ...
    if (highlighter.getFlags("body").contains(HighlightFlag.WEIGHT_MATCHES)) {
      ...
      assertArrayEquals(
          new String[] {"<b>one</b> <b>bravo</b> three... <b>four</b> <b>bravo</b> six"}, snippets);
    }
  ...
  public void testPreSpanQueryRewrite() throws IOException {
    ...
    assertArrayEquals(
        new String[] {
          "There is no <b>accord</b> <b>and</b> <b>satisfaction</b> with this - <b>Consideration</b> of the <b>accord</b> is arbitrary."
        },
        snippets);
  }
  ...
  private static class MyQuery extends Query {
    ...
    public boolean equals(Object obj) {
      return obj != null
          ...
          && wrapped.equals(((MyQuery) wrapped).wrapped);
    }
